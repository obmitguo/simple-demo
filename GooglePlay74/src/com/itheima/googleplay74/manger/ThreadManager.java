package com.itheima.googleplay74.manger;
...
public class ThreadManager {
	...
	public static class ThreadPool{
		...
		private long keepAliverTime;//休息时间
		
		private ThreadPoolExecutor executor;
		private ThreadPool(int corePoolSize,int maximumPoolSize,long keepAliveTime){
			this.corePoolSize = corePoolSize;
			this.maximumPoolSize = maximumPoolSize;
			this.keepAliverTime = keepAliveTime;
		}
		// 线程池几个参数的理解:
		...
		public void execute(Runnable r){
			if(executor==null){
				 executor=new ThreadPoolExecutor(corePoolSize, maximumPoolSize, keepAliverTime, TimeUnit.SECONDS, new LinkedBlockingQueue<Runnable>(),
